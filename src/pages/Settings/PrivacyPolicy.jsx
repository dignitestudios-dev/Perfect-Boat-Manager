...
const PrivacyPolicy = () => {
  return (
    <div className="h-full overflow-y-auto w-full p-2 lg:p-6 flex flex-col gap-6 justify-start items-start">
      <div className="w-full h-auto flex flex-col gap-4 p-4 lg:p-6 rounded-[16px] bg-[#001229]">
        ...
        <span className="text-[16px] font-normal">
          ...
          malesuada accumsan ornare quam elit tellus. Eros tellus imperdiet
          massa a. Quis odio non sapien molestie sit.
        </span>
        <span className="text-[16px] font-normal">
          Lorem ipsum dolor sit amet consectetur. Tellus ornare viverra arcu at
          gravida sed. Bibendum egestas tellus sollicitudin tortor porta arcu
