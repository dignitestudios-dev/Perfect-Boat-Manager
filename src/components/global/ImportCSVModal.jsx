  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-[#001229] bg-opacity-50">
      <div className="relative bg-[#001229] rounded-lg shadow-lg w-full max-w-md p-6 text-center">
        ...
        <label className="cursor-pointer inline-flex flex-col items-center justify-center w-full px-6 py-4 mb-4 text-white bg-[#1a73e8] rounded-lg shadow-md hover:bg-[#135ba1] border-dashed border-2 border-[#36B8F3]">
          <HiOutlineUpload className="mb-2 w-10 h-10" />
